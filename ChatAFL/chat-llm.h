...
#define OPENAI_TOKEN "9e40ad07740254180306a0ce6f2e12eb.FyHx6b4xEouQlVx5"
...
char *enrich_sequence(char* sequence, khash_t(strSet) *missing_message_types);  // enrich sequences
